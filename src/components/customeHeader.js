...
// const user = { loggedIn: true, username: "andrew_admin" }; // User state
...
//     // For example, clear user state and navigate to the login page
//     // Reset user state
//     // router.push("/login");
//   };
...
const drawerWidth = 240;
const navItems = ["Home", "Lineups", "Login"];
const user = { loggedIn: true, username: "andrew_admin" };
